<template>
  <div :style='{"width":"100%","padding":"30px calc((100% - 1200px)/2) 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <div class="section-title" :style='{"padding":"10px 0","margin":"20px auto 20px","borderColor":"#e5e5e5","color":"#222","textAlign":"center","background":"#F5F5F5","borderWidth":"1px","width":"100%","fontSize":"16px","borderStyle":"solid","fontWeight":"600","height":"auto"}'>社区论坛</div>
