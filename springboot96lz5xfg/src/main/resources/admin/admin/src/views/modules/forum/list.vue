	...
	<div class="main-content" :style='{"minHeight":"100vh","padding":"0px 0px 20px","overflow":"hidden","color":"#666","background":"#e5e6e6","fontSize":"14px","position":"relative"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"0px solid #bababa","padding":"20px","margin":"0px 0 0","overflow":"hidden","borderRadius":"0px","background":"none","width":"auto","fontSize":"inherit"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"20px","borderColor":"#355749","color":"#c2c2c2","textAlign":"center","flexDirection":"row","display":"flex","borderRadius":"4px","flexWrap":"wrap","background":"#fff","borderWidth":"2px 0 0","width":"100%","fontSize":"inherit","borderStyle":"solid"}' v-if="!forumChild">
				...
				<el-row :style='{"padding":"20px","borderColor":"#355749","color":"#c2c2c2","textAlign":"center","flexDirection":"row","display":"flex","borderRadius":"4px","flexWrap":"wrap","background":"#fff","borderWidth":"2px 0 0","width":"100%","fontSize":"inherit","borderStyle":"solid"}' v-if="forumChild">
					<el-button :style='{"cursor":"pointer","padding":"0 20px","borderColor":"#1576c2","margin":"0 10px","color":"#fff","minWidth":"80px","transition":"all 0.3s","outline":"none","borderRadius":"4px","background":"#78CD51","borderWidth":"0 0 0px","width":"auto","fontSize":"14px","borderStyle":"solid","height":"34px"}' type="success" @click="search()">返回</el-button>
				</el-row>
